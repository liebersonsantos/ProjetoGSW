package com.example.lieberson.projetogsw.view;
...
import com.example.lieberson.projetogsw.R;
import com.example.lieberson.projetogsw.model.Repository;

import java.util.List;

import static com.example.lieberson.projetogsw.utils.ImageUtil.loadImage;
...
public class RepositoryRecyclerAdapter extends RecyclerView.Adapter<RepositoryRecyclerAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            textViewDescription = itemView.findViewById(R.id.textViewDescricao);
        }
